...
In addition to generating local CSV outputs, this project includes an **optional** fully containerised **PostgreSQL and Grafana stack** for querying and interactive time-series visualisation, as well as an optional **Streamlit** web app for interactive visualisation.
